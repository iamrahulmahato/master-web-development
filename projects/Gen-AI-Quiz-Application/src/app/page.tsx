	...
	return (
		<>
			<div className="quizAppWrapper">
				<div className="animatedHeader" style={{ textAlign: "center", padding: "20px", backgroundColor: "#f0f0f0" }}>
        			<h1 style={{ fontSize: "3rem", color: "#333", textTransform: "uppercase", letterSpacing: "2px", animation: "pulse 2s infinite" }}>AI Powered Quiz App</h1>
    			</div>
