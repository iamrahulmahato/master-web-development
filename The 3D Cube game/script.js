        ...
        this.draggable.onDragMove = (position) => {
            ...
            if (this.state === PREPARING && this.dragTotal.length() > 0.05) {
                ...
                if (this.flipType === "layer") {
                    ...
                    this.flipAxis = objectDirection
                        .cross(this.dragNormal)
                        .negate();
        ...
        this.rotationTween = new Tween({
            ...
            onComplete: () => {
                ...
                this.game.cube.object.rotation.setFromVector3(
                    this.snapRotation(
                        this.game.cube.object.rotation.toVector3()
                    )
                );
    ...
    init() {
        this.ranges = {
            size: new Range("size", {
                ...
                onUpdate: (value) => {
                    ...
                    this.game.preferences.ranges.scramble.list.forEach(
                        (item, i) => {
                            item.innerHTML =
                                this.game.scrambler.scrambleLength[
                                    this.game.cube.size
                                ][i];
                        }
                    );
            ...
            theme: new Range("theme", {
                ...
                step: 1,
                onUpdate: (value) => {
                    const theme = ["cube", "erno", "dust", "camo", "rain"][
                        value
                    ];
